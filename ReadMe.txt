...
Version 1.8
- Removed a memory leak from SoundEngine when you unload effects.
- Now calls UIApplication to prevent dimming while the game is in progress.
- Previous version was difficult to control because the lateral rotation was too sensitive.  There's now a small spot where the side thrusters are not actually turned on.
